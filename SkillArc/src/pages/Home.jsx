    ...
    <>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        <div  data-aos="fade-left" className="-mt-3 w-[90%] text-center text-lg font-bold text-richblack-300">
          By taking our online coding courses, you can learn at your own pace, from
          anywhere in the world, and get access to a wealth of resources,
          including great projects, quizzes, and personalized guidance from
          instructors.
        </div>
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            ...
            <div className="flex flex-col items-start gap-10 lg:w-[40%]">
              <div className="text-[16px]">
                The SkillArc dictates its own terms. Today, to
